...
public class CityDAO extends GenericSqlDAO<City, Integer> {
	...
	public Integer create(City newInstance) {
		...
		try 
		{
			stmt = connection.prepareStatement("INSERT INTO CITY (CODE, NAME, FK_COUNTRY_ID) VALUES (?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
		...
		catch (SQLException e) 
		{
			...
			System.err.println(newInstance.toString());
		}     
